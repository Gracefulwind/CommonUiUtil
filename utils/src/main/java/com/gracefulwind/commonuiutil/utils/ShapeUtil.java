package com.gracefulwind.commonuiutil.utils;
 ...
 * @ClassName: ShapeUtil
 * @Author: Gracefulwind
 * @CreateDate: 2020/4/20 10:52
 * @Description: ---------------------------
 * @UpdateUser:
 * @UpdateDate: 2020/4/20 10:52
 * @UpdateRemark:
 * @Version: 1.0
...
//        }
     ...
     /**
      * @method  createCardShape
      * @description 简单的，设定好参数的调用方法。。。测试用，后期去除
